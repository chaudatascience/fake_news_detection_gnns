...
def train(config):
    ...
    ## mask is symmetric as this is undirected graph
    # torch.subtract(mask*1, mask.T*1).sum()
...
def train_UPFD():
    ## TODO 4: 
    ## apply to UPFD dataset Should be the same as `train_cora()` function, only change some arguments. Dataset info: https://pytorch-geometric.readthedocs.io/en/latest/notes/introduction.html
